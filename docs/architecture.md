---
summary: "Kotlin bridge ↔ Python toolset ↔ WebSocket relay; the 49 android_* tools and how a command flows end-to-end."
read_when:
...
- `usb/UsbDeviceManager.kt` — USB-host discovery, Android permission boundary, claimed-interface sessions, and bounded transfers.
