...
Easiest: download the prebuilt APK from the [Latest Build release](https://github.com/lEWFkRAD/hermes-android/releases/tag/latest-build) and install it (enable "Install unknown apps" when prompted, or `adb install hermes-android-*.apk`).
...
- Optional USB peripherals: connect through USB-C OTG, tap **Authorize USB Device**, and approve the system prompt.
