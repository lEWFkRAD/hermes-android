...
|-----|---------|-----------|
| [architecture.md](architecture.md) | Kotlin bridge ↔ Python toolset ↔ WebSocket relay; 49 `android_*` tools. | Changing relay/bridge/tool wiring; understanding data flow |
...
| [dependencies.md](dependencies.md) | Complete build, runtime, test, platform, and optional dependency inventory. | Setting up development; auditing dependencies; preparing an SBOM |
| [store-submission.md](store-submission.md) | Private-release path plus current Google Play and Galaxy Store constraints. | Publishing an APK/AAB; changing permissions or Accessibility behavior |
