...
object ScreenRecorder {
    ...
    fun record(durationMs: Long = 5000): Map<String, Any?> {
        ...
        handler.post {
            ...
            try {
                ...
                val mr = createMediaRecorder(service).apply {
    ...
    private fun createMediaRecorder(context: Context): MediaRecorder =
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            createMediaRecorderApi31(context)
        } else {
    ...
    private fun createMediaRecorderApi31(context: Context): MediaRecorder = MediaRecorder(context)
